      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">
            <span className="gradient-text">Featured Startup</span>
          </h2>

          <Card className="project-card bg-black/70 border border-purple-500/30 shadow-lg hover:shadow-purple-500/20 backdrop-blur-sm overflow-hidden">
              ...
              <div className="p-6 md:p-8 flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-white">Cerebramha</h3>
                  </div>
                  ...
                  <p className="text-gray-300 mb-6">
                    Built a multimodal AI model (MRI + clinical markers), deployed a full-stack FastAPI + React app, and
                    fine-tuned OpenAI models for medical insights.
                  </p>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-gray-300 text-sm">
                        Designed a dual-input CNN-MLP model combining 3D MRI scans and 49 health markers
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="min-w-5 mt-1">
                      ...
                      <p className="text-gray-300 text-sm">
                        Implemented a real-time AI assistant using OpenAI APIs and RAG
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="min-w-5 mt-1">
                      ...
                      <p className="text-gray-300 text-sm">
                        Led development using FastAPI, Supabase, React, with 3D Grad-CAM visualizations
                      </p>
                    </div>
                  </div>
                </div>
